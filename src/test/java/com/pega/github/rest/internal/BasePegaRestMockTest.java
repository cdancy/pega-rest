...
package com.pega.github.rest.internal;
...
/**
 * Base class for all PegaRest mock tests.
 */
public class BasePegaRestMockTest {

    protected String provider;
    private final JsonParser parser = new JsonParser();

    public BasePegaRestMockTest() {
        provider = "pega-rest";
    }

    public PegaRestApi api(URL url) {
        return ContextBuilder.newBuilder(provider).endpoint(url.toString()).overrides(setupProperties())
                .buildApi(PegaRestApi.class);
    }
